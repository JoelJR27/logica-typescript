...
const verificaSeEhAnagrama = (
  ...
  const ordenaString = (string: string) =>
    string.toLowerCase().split("").sort().join(""); // Transforma a string recebida como parâmetro em um array com as letras em ordem alfabetica
