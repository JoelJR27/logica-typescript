...
const encontraMaiorNumero = (array) => {
    const numerosOrdenados = array.sort((a, b) => b - a); // Ordena o array de forma decrescente.
    return `Maior ${numerosOrdenados[0]}, menor ${numerosOrdenados[numerosOrdenados.length - 1]}`; // Retorna o maior e o menor número do array.
};
